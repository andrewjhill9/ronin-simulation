...
public class Main {
  ...
  public static void main(String[] args) throws IOException {
    ...
    final CombatClass fireRoninLevel3 = new FireStanceRonin("Fire Ronin LVL 03", 3, 1, 8, 3, 19, 2, true);
    final CombatClass fireRoninLevel4 = new FireStanceRonin("Fire Ronin LVL 04", 4, 1, 8, 3, 19, 2, true);
    final CombatClass fireRoninLevel5 = new FireStanceRonin("Fire Ronin LVL 05", 5, 1, 8, 4, 19, 3, true);
    final CombatClass fireRoninLevel6 = new FireStanceRonin("Fire Ronin LVL 06", 6, 1, 8, 4, 19, 3, true);
    final CombatClass fireRoninLevel7 = new FireStanceRonin("Fire Ronin LVL 07", 7, 1, 8, 4, 19, 3, true);
    final CombatClass fireRoninLevel8 = new FireStanceRonin("Fire Ronin LVL 08", 8, 1, 8, 5, 19, 3, true);
    final CombatClass fireRoninLevel9 = new FireStanceRonin("Fire Ronin LVL 09", 9, 1, 8, 5, 19, 4, true);
    final CombatClass fireRoninLevel10 = new FireStanceRonin("Fire Ronin LVL 10", 10, 1, 8, 5, 19, 4, true);
    final CombatClass fireRoninLevel11 = new FireStanceRonin("Fire Ronin LVL 11", 11, 1, 8, 5, 18, 4, true);
    final CombatClass waterRoninLevel3_2_3 = new WaterStanceRonin("Water Ronin LVL 03/2/3", 3, 1, 8, 3, 19, 2, true, 2, 3);
    final CombatClass waterRoninLevel5_2_3 = new WaterStanceRonin("Water Ronin LVL 05/2/3", 5, 1, 8, 4, 19, 3, true, 2, 3);
    final CombatClass waterRoninLevel6_2_3 = new WaterStanceRonin("Water Ronin LVL 06/2/3", 6, 1, 8, 4, 19, 3, true, 2, 3);
    final CombatClass waterRoninLevel7_2_3 = new WaterStanceRonin("Water Ronin LVL 07/2/3", 7, 1, 8, 4, 19, 3, true, 2, 3);
    final CombatClass waterRoninLevel8_2_3 = new WaterStanceRonin("Water Ronin LVL 08/2/3", 8, 1, 8, 5, 19, 3, true, 2, 3);
    final CombatClass waterRoninLevel9_2_3 = new WaterStanceRonin("Water Ronin LVL 09/2/3", 9, 1, 8, 4, 19, 3, true, 2, 3);
    final CombatClass waterRoninLevel10_2_3 = new WaterStanceRonin("Water Ronin LVL 10/2/3", 5, 1, 8, 4, 18, 3, true, 2, 3);
    final CombatClass waterRoninLevel11_2_3 = new WaterStanceRonin("Water Ronin LVL 11/2/3", 11, 1, 8, 5, 18, 4, true, 2, 3);
    final CombatClass championFighterLevel3 = new ChampionFighter("Champion Fighter LVL 3", 3, 2, 6, 3, 19, 2);
    final CombatClass championFighterLevel5 = new ChampionFighter("Champion Fighter LVL 5", 5, 2, 6, 4, 19, 3);
    final CombatClass championFighterLevel8 = new ChampionFighter("Champion Fighter LVL 8", 8, 2, 6, 5, 19, 3);
    final CombatClass championFighterLevel10 = new ChampionFighter("Champion Fighter LVL 10", 10, 2, 6, 5, 19, 4);
    final CombatClass championFighterLevel11 = new ChampionFighter("Champion Fighter LVL 11", 11, 2, 6, 5, 19, 4);
    final CombatClass assassinRogueLevel3 = new AssassinRogue("Assassin Rogue LVL 3", 3, 2, 6, 3, 20, 2);
    final CombatClass assassinRogueLevel5 = new AssassinRogue("Assassin Rogue LVL 5", 5, 2, 6, 4, 20, 3);
    final CombatClass assassinRogueLevel8 = new AssassinRogue("Assassin Rogue LVL 8", 8, 2, 6, 5, 20, 3);
    final CombatClass assassinRogueLevel10 = new AssassinRogue("Assassin Rogue LVL 10", 10, 2, 6, 5, 20, 4);
    final CombatClass assassinRogueLevel11 = new AssassinRogue("Assassin Rogue LVL 11", 11, 2, 6, 5, 20, 4);
    final CombatClass waterRoninLevel3_0_3 = new WaterStanceRonin("Water Ronin LVL 03/0/3", 3, 1, 8, 3, 19, 2, true, 0, 3);
    final CombatClass waterRoninLevel3_1_3 = new WaterStanceRonin("Water Ronin LVL 03/1/3", 3, 1, 8, 3, 19, 2, true, 1, 3);
    final CombatClass waterRoninLevel3_2_1 = new WaterStanceRonin("Water Ronin LVL 03/2/1", 3, 1, 8, 3, 19, 2, true, 2, 1);
    final CombatClass waterRoninLevel3_2_2 = new WaterStanceRonin("Water Ronin LVL 03/2/2", 3, 1, 8, 3, 19, 2, true, 2, 2);
    final CombatClass waterRoninLevel3_2_4 = new WaterStanceRonin("Water Ronin LVL 03/2/4", 3, 1, 8, 3, 19, 2, true, 2, 4);
    final CombatClass waterRoninLevel6_0_3 = new WaterStanceRonin("Water Ronin LVL 06/0/3", 6, 1, 8, 4, 19, 3, true, 0, 3);
    final CombatClass waterRoninLevel6_1_3 = new WaterStanceRonin("Water Ronin LVL 06/1/3", 6, 1, 8, 4, 19, 3, true, 1, 3);
    final CombatClass waterRoninLevel6_2_1 = new WaterStanceRonin("Water Ronin LVL 06/2/1", 6, 1, 8, 4, 19, 3, true, 2, 1);
    final CombatClass waterRoninLevel6_2_2 = new WaterStanceRonin("Water Ronin LVL 06/2/2", 6, 1, 8, 4, 19, 3, true, 2, 2);
    final CombatClass waterRoninLevel6_2_4 = new WaterStanceRonin("Water Ronin LVL 06/2/4", 6, 1, 8, 4, 19, 3, true, 2, 4);
